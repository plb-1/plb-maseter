...
public class MyBaseExpandableListAdapter extends BaseExpandableListAdapter {
    ...
    public View getGroupView(final int groupPosition, boolean isExpanded, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            convertView = LayoutInflater.from(context).inflate(R.layout.tdyeblistparent_layout, null);
    ...
    public View getChildView(final int groupPosition, final int childPosition, boolean isLastChild, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            convertView = LayoutInflater.from(context).inflate(R.layout.tdyeblist_child_layout, null);
            ...
            childViewHolder.id_iv_logo = convertView.findViewById(R.id.id_iv_logo);

            childViewHolder.shopid  = convertView.findViewById(R.id.shopid);
        ...
        childViewHolder.id_iv_logo.setImageResource(goodsBean.getImageLogo());
        childViewHolder.shopid.setText(goodsBean.getId()+"");
...
//            childViewHolder.id_ll_edtoring.setVisibility(View.GONE);
        ...
        for (int i = 0; i < parentMapList.size(); i++) {
            ...
            for (int j = 0; j < childMapList.size(); j++) {
                ...
                if (goodsBean.isChecked()) {
                    ...
                    shopname.add(goodsBean.getName());
                    shopbynum.add(goodsBean.getCount());
                    shopid.add(goodsBean.getId());
                }
            }
        }
        //计算回调
        onGoodsCheckedChangeListener.onGoodsCheckedChange(totalCount, totalPrice,shopname,shopbynum,shopid);
    }
    ...
    public interface OnGoodsCheckedChangeListener {
        void onGoodsCheckedChange(int totalCount, double totalPrice, List shopname, List shopbynum, List shopid);
    }
